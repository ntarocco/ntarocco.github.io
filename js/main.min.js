...
function animateMapLoading(){function a(){if(b.text(b.text()+"."),c+=1,c>3){var d=b.text();b.text(b.text().substr(0,d.length-4)),c=0}setTimeout(a,1e3)}var b=$("#loading-map"),c=0;a()}function loadPopoverMap(a){function b(){setTimeout(function(){h.popover("hide"),i.popover("hide")},8e3)}function c(){setTimeout(function(){Cookies.set(f,1,{expires:14}),h.popover("show"),i.popover("show"),b()},3e3)}var d=$("#menu-popover"),e=$("#fullscreen-popover"),f="popoverAlreadyShown",g=Cookies.get(f);if(d&&e){var h=d.popover({placement:"top",title:"",content:a("map.tooltip.menu")}),i=e.popover({placement:"top",title:"",content:a("map.tooltip.fullscreen")});g&&"1"===g||c()}}!function(a){if("function"==typeof define&&define.amd)define(a);else if("object"==typeof exports)module.exports=a();else{var b=window.Cookies,c=window.Cookies=a();c.noConflict=function(){return window.Cookies=b,c}}}(function(){function a(){for(var a=0,b={};a<arguments.length;a++){var c=arguments[a];for(var d in c)b[d]=c[d]}return b}function b(c){function d(b,e,f){var g;if("undefined"!=typeof document){if(arguments.length>1){if(f=a({path:"/"},d.defaults,f),"number"==typeof f.expires){var h=new Date;h.setMilliseconds(h.getMilliseconds()+864e5*f.expires),f.expires=h}try{g=JSON.stringify(e),/^[\{\[]/.test(g)&&(e=g)}catch(i){}return e=c.write?c.write(e,b):encodeURIComponent(String(e)).replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g,decodeURIComponent),b=encodeURIComponent(String(b)),b=b.replace(/%(23|24|26|2B|5E|60|7C)/g,decodeURIComponent),b=b.replace(/[\(\)]/g,escape),document.cookie=[b,"=",e,f.expires&&"; expires="+f.expires.toUTCString(),f.path&&"; path="+f.path,f.domain&&"; domain="+f.domain,f.secure?"; secure":""].join("")}b||(g={});for(var j=document.cookie?document.cookie.split("; "):[],k=/(%[0-9A-Z]{2})+/g,l=0;l<j.length;l++){var m=j[l].split("="),n=m.slice(1).join("=");'"'===n.charAt(0)&&(n=n.slice(1,-1));try{var o=m[0].replace(k,decodeURIComponent);if(n=c.read?c.read(n,o):c(n,o)||n.replace(k,decodeURIComponent),this.json)try{n=JSON.parse(n)}catch(i){}if(b===o){g=n;break}b||(g[o]=n)}catch(i){}}return g}}return d.set=d,d.get=function(a){return d(a)},d.getJSON=function(){return d.apply({json:!0},[].slice.call(arguments))},d.defaults={},d.remove=function(b,c){d(b,"",a(c,{expires:-1}))},d.withConverter=b,d}return b(function(){})});var translationFr={nav:{home:"Accueil",info:"Info",access:"Arriver",accommodation:"Dormir",map:"Plan",rsvp:"RSVP"},info:{theBig:"Le grand",day:"jour",left:{when:"Quand",date:"Samedi, 1 julliet 2017",ceremony:"Messe: 16h00 \n Dine: 19h00"},right:{where:"Où",ceremony:{title:"Messe",description:"Chiesa di Santa Teresa del bambin Gesù \n Piazza della Chiesa \n Rosignano Marittimo"},party:{title:"Fete",description:"Villa Parisi \n Via Romolo Monti, 10 \n 57016 Castiglioncello (LI) \n www.villaparisi.com"}}},access:{title:"Comme arriver"},accomodation:{title:"Dormir"},map:{tooltip:{menu:"Cliquez sur l'icône pour afficher le menu avec les points d'intérêt",fullscreen:"Cliquez sur l'icon pour agrandir"},loading:"Chargement du plan"}},translationIt={nav:{home:"Home",info:"Info",access:"Raggiungerci",accommodation:"Dormire",map:"Mappa",rsvp:"RSVP"},info:{theBig:"Il grande",day:"giorno",left:{when:"Quando",date:"Sabato, 1 luglio 2017",ceremony:"Cerimonia: 16h00 \n Cena: 19h00"},right:{where:"Dove",ceremony:{title:"Cerimonia",description:"Chiesa di Santa Teresa del bambin Gesù \n Piazza della Chiesa \n Rosignano Marittimo"},party:{title:"Cena",description:"Villa Parisi \n Via Romolo Monti, 10 \n 57016 Castiglioncello (LI) \n www.villaparisi.com"}}},access:{title:"Come arrivare"},accomodation:{title:"Dove dormire"},map:{tooltip:{menu:"Clicca sull'icona per mostrare il menu con i punti di interesse",fullscreen:"Clicca sull'icon per ingrandire"},loading:"Caricamento della mappa"}},DEBUG=false,AUTOSTART_COUNTDOWN=!DEBUG,AUTOSTART_CAROUSEL=!DEBUG,AUTOSTART_VIDEO_BG=!DEBUG;!function(){function a(){$.getJSON("//freegeoip.net/json/?callback=?",function(a){var b,e="",f=JSON.stringify(a,null,2);"country_code"in f&&(e=f.country_code.toLowerCase()),-1!==e.indexOf("fr")?b="fr":-1!==e.indexOf("it")&&(b="it"),b?d(b):c()}).fail(function(){c()})}function b(){var a=navigator.languages?navigator.languages[0]:navigator.language||navigator.userLanguage;return a=a.toLowerCase(),-1!==a.indexOf("fr")?"fr":-1!==a.indexOf("it")?"it":void 0}function c(){d(b())}function d(a){a||(a="fr"),Cookies.set(e,a),i18next.init({debug:DEBUG,fallbackLng:!1,lng:a,resources:{fr:{translation:translationFr},it:{translation:translationIt}}},function(a,b){jqueryI18next.init(i18next,$,{tName:"t",selectorAttr:"data-i18n",targetAttr:"i18n-target",optionsAttr:"i18n-options",useOptionsAttr:!1,parseDefaultValueFromContent:!0});var c=$("body");$("#changeLanguageIt").click(function(){i18next.changeLanguage("it",function(a,b){Cookies.set(e,"it"),c.localize()})}),$("#changeLanguageFr").click(function(){i18next.changeLanguage("fr",function(a,b){Cookies.set(e,"fr"),c.localize()})}),c.localize(),animateMapLoading(),loadPopoverMap(b)})}var e="language",f=Cookies.get(e);f?d(f):a()}($),function(a){a("#carousel").flickity({autoPlay:AUTOSTART_CAROUSEL,imagesLoaded:!0,percentPosition:!1,setGallerySize:!1})}($),function(a){var b=864e5,c=new Date(2017,6,1,16,0,0),d=new Date,e=Math.round(Math.abs((c.getTime()-d.getTime())/b));a("#countdown-full").FlipClock(c.getTime()/1e3-d.getTime()/1e3,{autoStart:AUTOSTART_COUNTDOWN,clockFace:"DailyCounter",countdown:!0});var f=a("#countdown-day");f.FlipClock(e,{autoStart:AUTOSTART_COUNTDOWN,clockFace:"Counter",countdown:!1,callbacks:{create:function(){setTimeout(function(){a('<span class="flip-clock-divider days"><span class="flip-clock-label">Days</span></span>').hide().prependTo(f).fadeIn("slow")},1e3)}}})}($),function(a){function b(a){var b=a.split(".html")[0];return-1!==window.location.pathname.indexOf(b)}function c(a){return 2==a.length}function d(b){a("html, body").animate({scrollTop:"top"===b?0:a("#"+b).offset().top},500)}a("nav").find(".navbar-nav").find("a").click(function(){var e=a.attr(this,"href"),f=e.split("#");return b(e)&&c(f)?(d(f[1]),!1):!0})}($),function(a){var b=a(window),c=b.width(),d=a("#video-bg");d&&c>=768&&d.attr("autoplay",AUTOSTART_VIDEO_BG)}($);